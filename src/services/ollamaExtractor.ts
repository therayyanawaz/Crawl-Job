/**
 * @deprecated Use src/services/llmExtractor.ts for new code.
 * This file is kept for backward compatibility.
 * All symbols are re-exported from llmExtractor.ts.
 */
export * from './llmExtractor.js';

// Original implementation preserved below — now handled by llmExtractor.ts
// Keeping for git history and reference.
// /**
